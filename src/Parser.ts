...
Parser.prototype.parsePmd = function ( buffer, leftToRight ) {
    ...
    const parseIks = function () {

        const parseIk = function () {
    ...
    const parseMorphFrames = function () {

        const parseMorphFrame = function () {
    ...
    const parseBoneFrameNames = function () {

        const parseBoneFrameName = function () {
    ...
    const parseBoneFrames = function () {

        const parseBoneFrame = function () {
    ...
    const parseEnglishHeader = function () {
    ...
    const parseEnglishBoneNames = function () {

        const parseEnglishBoneName = function () {
    ...
    const parseEnglishMorphNames = function () {

        const parseEnglishMorphName = function () {
    ...
    const parseEnglishBoneFrameNames = function () {

        const parseEnglishBoneFrameName = function () {
    ...
    const parseToonTextures = function () {

        const parseToonTexture = function () {
